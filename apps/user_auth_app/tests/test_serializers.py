"""
Tests for authentication-related serializers.
...
class TestRegisterSerializer(TestCase):
    ...
    def test_register_success_creates_inactive_user(self):
        """
        RegisterSerializer should create an inactive user with a usable password.
        """
        data = {
            "email": "a@example.com",
            "password": "Passw0rd!!",
    ...
    def test_register_password_mismatch(self):
        """
        RegisterSerializer should fail if password and confirmed_password differ.
        """
        data = {
    ...
    def test_register_duplicate_email(self):
        """
        RegisterSerializer should fail if the email is already in use.
        """
...
class TestLoginSerializer(TestCase):
    """
    Tests for LoginSerializer behavior.
    """

    def test_login_success(self):
        """
        LoginSerializer should return access/refresh tokens for valid credentials.
        """
    ...
    def test_login_wrong_password(self):
        """
        LoginSerializer should fail for incorrect password.
        """
        User.objects.create_user(
            username="u2",
    ...
    def test_login_inactive_user_denied(self):
        """
        LoginSerializer should fail for inactive users.
        """
        User.objects.create_user(
            username="u3",
    ...
    def test_login_nonexistent_user(self):
        """
        LoginSerializer should fail if the user does not exist.
        """
...
class TestPasswordConfirmSerializer(TestCase):
    """
    Tests for PasswordConfirmSerializer behavior.
    """

    def test_password_confirm_success(self):
        """
        PasswordConfirmSerializer should update the user's password when valid.
        """
        user = User.objects.create_user(
            username="u4",
    ...
    def test_password_confirm_mismatch(self):
        """
        PasswordConfirmSerializer should fail when passwords do not match.
        """
        user = User.objects.create_user(
            username="u5",
        ...
        s = PasswordConfirmSerializer(
            instance=user,
            data={"new_password": "NewPassw0rd!!", "confirm_password": "nope"},
        )
        self.assertFalse(s.is_valid())
        self.assertIn("detail", s.errors)